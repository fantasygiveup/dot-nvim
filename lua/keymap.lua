...
M.plugins = function()
  ...
  -- Telescope.
  vim.keymap.set("n", "<Leader><", "<cmd>lua require('telescope.builtin').buffers({sort_lastused = true })<cr>")
  ...
  vim.keymap.set("n", "<localleader>fr", "<cmd>lua require('telescope.builtin').oldfiles()<cr>")
