...
keybind("n", "<Leader><", "<Cmd>lua require'telescope.builtin'.buffers({sort_lastused = true, ignore_current_buffer = true })<CR>", nsopts)
keybind("n", "<Leader>//", "<Cmd>lua require'telescope.builtin'.grep_string({word_match = '-w'})<CR>", nsopts)
...
keybind("n", "<Leader>#", "<Cmd>Telescope filetypes<CR>", nsopts)
keybind("n", "<Leader>gg", "<Cmd>Telescope git_status<CR>", nsopts)
...
keybind("n", "<Leader>pp", "<Cmd>Telescope repo list<CR>", nsopts)
