...
M.plugins = function()
  ...
  vim.keymap.set("n", "<leader>pp", "<cmd>lua require'fzf_projects'.navigate()<cr>")
  vim.keymap.set("n", "<leader>os", "<cmd>lua require'internal'.fzf_search_notes()<cr>")
  ...
  vim.keymap.set("n", "<leader>?", "<cmd>lua require'treesitter_buffer_overview'.show()<cr>")
