...
keybind("n", "<C-t>", "<Cmd>nohlsearch | FzfFiles<CR>", nsopts)
keybind("n", ",b", "<Cmd>nohlsearch | FzfBuffers<CR>", nsopts)
keybind("n", "<Leader>//", "<Cmd>nohlsearch | FzfRg<CR>", nsopts)
keybind("v", "<Leader>//", [[:<C-U>exec 'nohlsearch | FzfRg ' . luaeval('require"internal".visual_selection()')<CR>]], nsopts)
