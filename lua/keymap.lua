...
keybind("n", ",b", "<Cmd>FzfBuffers<CR>", nsopts)
keybind("n", ",s", "<Cmd>FzfRg<CR>", nsopts)
keybind("v", ",s", [[:<C-U>exec 'FzfRg ' . luaeval('require"internal".visual_selection()')<CR>]], nsopts)
keybind("n", "<Leader>?", "<Cmd>FzfMaps<CR>", nsopts)
keybind("n", "<Leader>:", "<Cmd>FzfCommands<CR>", nsopts)
keybind("n", ",#", "<Cmd>FzfFiletypes<CR>", nsopts)
keybind("n", ",fr", "<Cmd>FzfHistory<CR>", nsopts)
